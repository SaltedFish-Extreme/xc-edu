  ...
  <div>
    ...
    <el-col :span="24" class="header">
      <el-col :span="14" class="logo">
        <img alt="" src="/static/images/asset-logoIco-white.png" width="500px">{{collapsed ? '' : sysName}}
      </el-col>
      <!--<el-col :span="10">
      ...
      <el-col :span="10" class="userinfo" v-if="this.logined">
        ...
        <div class="nav">
          ...
          <div class="usermenu">
            ...
            <a :loading="editLoading" @click="logout" href="javascript:;"><i class="el-icon-circle-close"></i>退出</a>
          </div>
        </div>
      </el-col>
    </el-col>
